(function () {
    ...
    function selectMenuItem(item, left) {
        ...
        if (left && !modern) {
            item.style.setProperty("background-color", "#f4f6f8", "important");
            item.style.setProperty("border-radius", "5px 0 0 5px", "important");
            item.style.setProperty("opacity", "1", "important");
            item.style.setProperty("box-shadow", "none", "important");
            item.style.setProperty("width", "82px", "important");
