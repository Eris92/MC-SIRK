(function () {
    ...
    function ensureModeStyles() {
        ...
        style.textContent = [
            ...
            ".mc-shared-page-mycommands.is-edit-mode .mc-shared-layout{grid-template-columns:96px 500px minmax(260px,1fr)!important}",
            ".mc-shared-page-mycommands.is-edit-mode .mc-shared-layout.is-collapsed{grid-template-columns:56px 500px minmax(260px,1fr)!important}",
            ...
            "@media(max-width:1100px){.mc-shared-page-mycommands.is-edit-mode .mc-shared-layout{grid-template-columns:82px 440px minmax(220px,1fr)!important}.mc-shared-page-mycommands.is-edit-mode .mc-shared-layout.is-collapsed{grid-template-columns:56px 440px minmax(220px,1fr)!important}.mc-shared-page-mycommands.is-multi-mode .mc-shared-layout{grid-template-columns:82px minmax(380px,55%) minmax(220px,1fr)!important}.mc-shared-page-myscripts.is-multi-mode .mc-shared-layout{grid-template-columns:minmax(150px,200px) minmax(380px,52%) minmax(220px,1fr)!important}.mc-shared-page.is-multi-mode .mc-shared-layout.is-collapsed{grid-template-columns:56px minmax(380px,55%) minmax(220px,1fr)!important}}",
            "@media(max-width:800px){.mc-shared-page-mycommands:is(.is-edit-mode,.is-multi-mode) .mc-shared-layout,.mc-shared-page-mycommands:is(.is-edit-mode,.is-multi-mode) .mc-shared-layout.is-collapsed{grid-template-columns:1fr!important}}"
        ].join("");
