...
# PL: Protokół Jira Asset|Wybierz użytkownika, sprzęt i operację dla każdej pozycji oraz przedstawiciela IT.
# EN: Jira Asset Protocol|Select a Jira user, equipment, a per-asset operation and the IT representative.
...
# VariableUserRequired: $ItPerson, Przedstawiciel IT|Lista użytkowników MeshCentral; domyślnie aktualnie zalogowany operator.
