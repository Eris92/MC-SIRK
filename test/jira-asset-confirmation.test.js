...
(async function () {
    ...
    var snapshot = await service.snapshot(user(), [{ assetId: "1001", action: "receive" }, { assetId: "1002", action: "return" }]);
    ...
    console.log("Jira per-asset confirmation snapshots, stale gate and verified writes: OK");
