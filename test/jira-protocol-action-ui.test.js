...
assert.ok(dialog.indexOf('text(variable && variable.name) === "IsTransferProtocol"') >= 0, "Legacy global mode must be hidden for protocol steps.");
...
console.log("Jira per-asset action UI uses shared checklist ownership and no global mode: OK");
