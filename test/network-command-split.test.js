...
assert.ok(properties.indexOf('$verbs=@($item.Verbs())') >= 0 &&
    ...
    properties.indexOf("'^(Properties|Właściwości)
...
console.log("Network panel and active-adapter properties use the synchronous Windows Shell PIDL properties contract: OK");") >= 0 &&
