    ...
    var catalog = {
        network: {
            key: "network", title: "Network", icon: "🌐", commands: [
                ...
                { id: "network-settings", label: "Network Control", locales: { pl: { label: "Network Control" }, en: { label: "Network Control" } }, description: "Open the native Network Connections panel.", type: 1, runAsUser: 2, cmd: "start \"\" control.exe ncpa.cpl" },
                { id: "network-adapter-properties", label: "Network Settings", locales: { pl: { label: "Network Settings" }, en: { label: "Network Settings" } }, description: "Open properties for the adapter used by the preferred active default route.", type: 1, runAsUser: 2, cmd: "start \"\" powershell.exe -NoProfile -WindowStyle Hidden -Command \"$route=Get-NetRoute -DestinationPrefix '0.0.0.0/0' -ErrorAction SilentlyContinue|Where-Object{$_.State -eq 'Alive'}|Sort-Object @{Expression={([long]$_.RouteMetric)+([long]$_.InterfaceMetric)};Ascending=$true},InterfaceMetric,RouteMetric,InterfaceIndex|Select-Object -First 1;if(-not $route){$route=Get-NetRoute -DestinationPrefix '::/0' -ErrorAction SilentlyContinue|Where-Object{$_.State -eq 'Alive'}|Sort-Object @{Expression={([long]$_.RouteMetric)+([long]$_.InterfaceMetric)};Ascending=$true},InterfaceMetric,RouteMetric,InterfaceIndex|Select-Object -First 1};if(-not $route){throw 'No active default route was found.'};$adapter=Get-NetAdapter -InterfaceIndex $route.InterfaceIndex -ErrorAction Stop;$shell=New-Object -ComObject Shell.Application;$folder=$shell.Namespace(49);if(-not $folder){throw 'Network Connections shell folder is unavailable.'};$item=$folder.Items()|Where-Object{$_.Name -eq $adapter.Name}|Select-Object -First 1;if(-not $item){throw ('Network connection was not found: '+$adapter.Name)};$source=[Text.Encoding]::UTF8.GetString([Convert]::FromBase64String(''));Add-Type -TypeDefinition $source -ErrorAction Stop;[SirkNetworkShell]::ShowProperties($item)\"" },
        ...
        system: {
            key: "system", title: "System", icon: "⚙", commands: [
                { id: "powershell", label: "PowerShell", description: "Open a PowerShell window for the interactive user.", type: 1, runAsUser: 2, cmd: "start \"\" powershell.exe -NoExit" },
                { id: "cmd", label: "CMD", description: "Open Command Prompt for the interactive user.", type: 1, runAsUser: 2, cmd: "start \"\" cmd.exe /K" },
