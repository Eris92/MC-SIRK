...
- [`0.1.125`](0.1.125.md) — makes development revisions visible to MeshCentral's plugin updater and reloads version-changed MC-SIRK backend modules from the stable entrypoint;
