...
- [`0.1.1-dev.44`](0.1.1-dev.44.md) — Windows #238: real Windows PowerShell Network Connections namespace smoke in the maintained CI workflow; Linux npm test remains canonical;
