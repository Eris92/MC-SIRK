...
- [`0.1.1-dev.32`](0.1.1-dev.32.md) — zintegrowana rewizja smoke po PR #233/#234: single-pending Move Requests per stable host oraz wzajemnie wykluczające się zaznaczenie Commands/Plugins;
